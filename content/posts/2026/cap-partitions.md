...
Turns out, "Partition Tolerance" isn't about a data partition at all; it's about the behavior of the network. In this context, the word partition is a verb. It means that when one of the nodes goes <abbr title="Absent Without Leave - US slang meaning 'to disappear'">AWOL</abbr>, the system continues operating — though what "operating" looks like depends on the system’s design.
